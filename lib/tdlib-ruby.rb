...
require 'tdlib/logging'
require 'tdlib/client_extensions'
require 'tdlib/file_manager'
require 'tdlib/message_handler'
require 'tdlib/message_sender'
require 'tdlib/markdown'
